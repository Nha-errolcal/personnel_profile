...
<div class="layout-content">
    <header class="layout-header d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center gap-3">
            <button id="toggleSidebar" class="btn btn-outline-secondary"><i class="fa fa-bars"></i></button>
            <h2 class="m-0" id="modalTitle">Clubs & Activities</h2>
        </div>
        <button class="btn btn-success" id="btnNew"><i class="fa fa-plus"></i> Add Club</button>
    </header>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form">
                        ...
                        <input type="text" class="form-control mb-3" name="role_name" id="role_name">
                        <label>Status</label>
...
<script>
    ...
    document.querySelectorAll(".btnEdit").forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            document.getElementById("role_name").value = club.role_name;
